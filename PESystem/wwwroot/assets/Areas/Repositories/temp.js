    ...
    const Export = {
        ...
        exportAllToExcel: async () => {
            try {
                ...
                exportButton.src = "~/assets/img/loading.gif"; // Có thể thay bằng spinner icon
                ...
                exportButton.src = "~/assets/img/excel.png";
            }
        }
    };
    ...
    const Total = {
        updateTotalScrapAndCategories: async () => {
            try {
                ...
                const classifyResponse = await fetch(`${API_CLASSIFY_SCRAP}?category=Scrap_done,Scrap_no_Task,No_Scrap`, {
                    method: 'GET',
                    headers: { 'Content-Type': 'application/json' }
                });
